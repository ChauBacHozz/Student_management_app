...
public class Student {
    ...
    public String getRegistered_class() {
        return registered_class;
    }

    public void setRegistered_class(String registered_class) {
        this.registered_class = registered_class;
    }

    public String getClass_completed() {
        return class_completed;
    }

    public void setClass_completed(String class_completed) {
