...
public class Department_student_panel extends rounded_panel{
    public Department_student_middle_panel pmid;
    public Department_student_panel(int radius, Color color){
        super(radius, color);
        setOpaque(false);
        ...
        pmid = new Department_student_middle_panel();
